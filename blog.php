        ...
        <ul class="navbar-nav ml-auto text-center">
          <li class="nav-item dropdown ">
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
              ...
              <li><a class="dropdown-item" href="onepage-slider.php">Onepage</a></li>
              <li><a class="dropdown-item" href="onepage-text.php">Onepage 2</a></li>
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdown02">
              ...
              <li><a class="dropdown-item" href="blog.php">Blog Page</a></li>
              <li><a class="dropdown-item" href="single-post.php">Blog Single Page</a></li>
      ...
      <div class="row justify-content-around">
        ...
        <div class="col-lg-3 col-md-6 mb-5 mb-lg-0">
          <ul>
            ...
            <li><a href="service.php">Ui/Ux Design</a></li>
            <li><a href="service.php">Graphic Design</a></li>
            <li><a href="service.php">Web Design</a></li>
